...
set -e
AUTHORS_FILE="$(git rev-parse --show-toplevel)/AUTHORS.txt"
...
echo "To this project contribute following authors:" | tee "$AUTHORS_FILE"
echo "$AUTHORS" | tee -a "$AUTHORS_FILE"
echo -e "\nThank you!" | tee -a "$AUTHORS_FILE"
